...
# Set computer name
sudo scutil --set ComputerName sangam
sudo scutil --set LocalHostName sangam
sudo scutil --set HostName sangam
...
defaults write NSGlobalDomain AppleLocale -string "en_IN@calendar=indian"
